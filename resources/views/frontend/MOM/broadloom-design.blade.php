                ...
                <div class="row breadcrumb_box  align-items-center">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 text-center text-sm-left" id="collection_heading">
                        <h3 class="pd-design-id breadcrumb-title text-center ">
                            ...
                            @else
                            {!! isset($sub_category) && $sub_category ? $sub_category : (isset($collections[array_key_first($collections)][0]) ? $collections[array_key_first($collections)][0]['Title'] : $main_collection['Description']) !!}
                            @endif
                            Collection
                        </h3>
                    </div>
        ...
        <section class="collection-section">
            <div class="container">
                <div class="d-flex justify-content-lg-between coll-pg product-wrapper collection-prdt-wrapper" id="sub_collections_wrapper">
                    <div class="p-0 col-md-12 col-sm-12 col-12 mb-5">
                        @if(count($collections))
                        <div class="broadloom-design-description mb-5 text-center">
                            <p>Hand Made of Tencel Silk</p>
                            <p>Made of a new-age fiber, know as tence! silk, it's soft like silk and strong like wool with a shimmering effect. 
                                This carpet is handmade and with all handmade carpets there are minor variations throughout which only adds to its beauty.
                            </p>
                        </div>
                        <div class="d-flex flex-row justify-content-left three-col product-listing d-flex flex-wrap">
                            @foreach($collections[array_key_first($collections)] as $collection)
                            <div class="p-0 col-md-4 grid-item" {{$with_title ? 'style="padding-right: 10px; padding-left: 10px;"' : ''}}>
                                @if(!$with_title)
