                                        ...
                                        <div
                                            ...
                                            <div class="d-flex flex-row justify-content-between column-gap-20 mb-3">
                                                <div class="d-flex flex-column fullwidth">
                                                    ...
                                                    @if (isset($countries))
                                                    <select name="country" id="countries" class="form-control bg-white checkout-dropdown">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.qty-add').on('click', function() {
                ...
                $('input[type="number"]', $(this).parent()).val((parseInt(value) + 1) < 1001 ? parseInt(
                    value) + 1 : 1000).change();
            });

            $('.qty-minus').on('click', function() {
                var value = $('input[type="number"]', $(this).parent()).val();
                $('input[type="number"]', $(this).parent()).val((parseInt(value) - 1) > 1 ? parseInt(
                    value) - 1 : 1).change();
            });
