...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="{{asset('/LR/favicon.ico')}}">
    ...
    <script src="{{asset('/LR/js/plugins/plugins.js')}}"> </script>
    <script src="{{asset('/LR/js/vendor/modernizr-2.8.3.min.js')}}"></script>
