...
<header class="d-flex flex-row flex-wrap">
    <div class="container-fluid extra-padding-lr top-header-wrap d-flex home-header">
        ...
        <div class="col-6 col-xs-2 col-sm-2 col-md-2 text-center">
            <a href="{{route('frontend.home')}}" class="logo">
                <img src="{{ asset($basicSettings -> logo_light) }}" alt="{{$basicSettings -> name}}" />
            </a>
        </div>
