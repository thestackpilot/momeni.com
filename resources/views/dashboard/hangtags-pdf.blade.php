    ...
    <div style="width:100%;" class="divbg">
        ...
        <center>
            ...
            <table width="100%" style="width: 100%">
                <tbody>
                    <tr>
                        <td style="width:50%; vertical-align: top; padding:0;" class="left-div">
                          <p style="border:0; background-color: #ffffff; ">
                              <div style="border:0; background-color: #ffffff; ">
                                <center>
                                    <font color="#000000" face="Arial" style="font-size:24px;color: grey;" class="mb-3">
                                        <span>SIZES AVAILABLE</span>
                                    </font>
                                    <div class="" style="margin-top: 50px;">
                                        @if (isset($product['barcodes']))
                                            @foreach($product['barcodes'] as $barcode)
                                            <span style="border:0; background-color: #ffffff; width: 150px; display: inline-block; margin-bottom: 20px;">
                                                <p class="m-0" style="margin: 0;">{{$barcode['label']}}</p>
                                                <div style="margin-top: 5px;">
                                                    <img src="data:image/png;base64,{!!DNS1D::getBarcodePNG($barcode['code'], 'UPCA', 1, 30, array(0,0,0), true)!!}" width="">
                                                </div>
                                            </span>
                                            @endforeach
                        ...
                        <td style="width:50%; vertical-align: top;" class="right-div">
                          <p style="border:0; background-color: #ffffff; ">
                              <div style="border:0; background-color: #ffffff; ">
                                <div>
                                    ...
                                    <div class="mb-5 pb-3" style="margin-bottom: 3rem; padding-bottom: 3rem; text-align: center;">
                                        <img src = "{{ $product['logo'] }}" width="200" onerror="this.onerror=null; this.src='{{url('/').$error_image}}'" style="text-align: center;" />
                                        @if(isset($header))
                                            <div>
                                    ...
                                    <div>
                                        {{-- title --}}
                                        <div style="font-size:22px;color: grey; text-align: center; margin-bottom: 30px;">
                                            <p style="margin-bottom: 30px;"><b>{{$product['category']}}</b></p>
                                                    ...
                                                    <td>
                                                        @foreach($product['attributes'] as $attribute)
                                                            <div class="style2 text-center" style="text-align: center;margin-top: 30px;">
                                                                <div style="font-size:18px;color: grey;margin-bottom: 20px;">
                                                                    <span><b>{{$attribute['label']}}: </b></span>
                                                                    <span class="mb-0">{{$attribute['value']}} </span>
                                                                </div>
                                                            </div>
                                                        @endforeach
                                                    </td>
