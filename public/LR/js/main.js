// TODO : Million Dollar question - why we have this JS in place? Is'nt this legacy inclusion ? 
(function ($) {
    "use strict";
    ...
    windows.on('scroll', function () {
        ...
        if (screenSize >= 320) {
            ...
            if (scroll < $('.Container-fluid#myHeader').height()) {
                $('.Container-fluid#myHeader').removeClass('sticky-fillter');
            } else {
                $('.Container-fluid#myHeader').addClass('sticky-fillter');
            }
        }
    ...
    $('.projects-masonary-wrapper, .masonry-activation, [data-masonry]').imagesLoaded(function () {
