...
class ShowroomsMeta extends Model
{
    protected $fillable = ['id','showroom_id','title','area','address', 'is_active'];
    // get all showrooms from DB
    public function get_showroom_meta($showroom_id)
    {
        return $this->where('showroom_id',$showroom_id)->get();
    }
    // Define Relation with showrooms
