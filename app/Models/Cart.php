...
class Cart extends Model
{
    ...
    protected $fillable = ['user_id', 'customer_id', 'item_id', 'item_name', 'item_quantity', 'item_price', 'item_color', 'item_size', 'item_currency', 'item_image', 'item_eta', 'item_data', 'oak_item', 'oak_sku'];
    ...
    public function get_cart_for_front( $ApiObj )
    {
        ...
        $cart_items     = $this->where( 'user_id', $user_id )->whereIn( 'customer_id', $customers )->get();
...
//                "ATSQ"                   => isset( $item_price['ATSQ'] ) && $item_price['ATSQ'] ? $item_price['ATSQ'] : 0
    ...
    public function remove_cart_item( $user_id, $customer_id, $item_id, $delete_all = false )
    {
